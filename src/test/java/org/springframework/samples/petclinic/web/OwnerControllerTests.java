...
class OwnerControllerTests {
	...
	void testProcessCreationFormSuccess() throws Exception {
		mockMvc.perform(post("/owners/new").param("firstName", "Joe").param("lastName", "Bloggs").with(csrf())
				.param("dni", "12345678L").param("birthDate", "1980-02-03").param("gender", "0")
				.param("email", "joe@gmail.com").param("telephone", "0131676163"))
	...
	void testProcessCreationFormHasErrors() throws Exception {
		mockMvc.perform(post("/owners/new").with(csrf()).param("firstName", "Joe").param("lastName", "Bloggs")
				.param("dni", "12345678").param("birthDate", "1980-02-03").param("gender", "14")
				.param("email", "joe@gmail.com").param("telephone", "0131676163")).andExpect(status().isOk())
	...
	void testProcessUpdateOwnerFormSuccess() throws Exception {
		mockMvc.perform(post("/owners/{ownerId}/edit", TEST_OWNER_ID).with(csrf()).param("firstName", "Joe")
				.param("lastName", "Bloggs").param("dni", "12345678P").param("birthDate", "1980-02-03")
				.param("gender", "0").param("email", "joe2@gmail.com").param("telephone", "016162919"))
	...
	void testProcessUpdateOwnerFormHasErrors() throws Exception {
		mockMvc.perform(post("/owners/{ownerId}/edit", TEST_OWNER_ID).with(csrf()).param("firstName", "Joe")
				.param("lastName", "Bloggs").param("dni", "12345678P").param("birthDate", "2024-02-08")
				.param("gender", "5").param("email", "joe2@gmail.com").param("telephone", "0161629159"))
