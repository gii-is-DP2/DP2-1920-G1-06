...
public class NegativeEditPropertyUITest {
		...
		public void editAProperty() throws Exception {
			...
			assertEquals("no puede estar vacío", driver.findElement(By.xpath("//form[@id='add-property-form']/div/div[3]/div/span[2]")).getText());
